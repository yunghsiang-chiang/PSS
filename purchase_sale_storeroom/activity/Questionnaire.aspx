    ...
    <div class="container my-5">
        ...
        <div class="section">
            ...
            <div class="mb-3">
                ...
                <div>
                    <input type="radio" name="check-in" value="否" checked> 否
                    <input type="radio" name="check-in" value="是"> 是
                </div>
            </div>
            <div class="mb-3 hidden" id="social-platforms">
        ...
        <div class="section">
            ...
            <div class="mb-3">
                ...
                <div>
                    <input type="radio" name="message-board" value="否" checked> 否
                    <input type="radio" name="message-board" value="是"> 是
                </div>
            </div>
            <div class="mb-3 hidden" id="message-board-colors">
            ...
            <div class="mb-3 hidden" id="message-board-colors-2">
                <label class="form-label">顏色選擇2：</label>
            ...
            <div class="mb-3">
                ...
                <div>
                    <input type="radio" name="balloon" value="否" checked> 否
                    <input type="radio" name="balloon" value="是"> 是
                </div>
            </div>
            <div class="mb-3 hidden" id="balloon-colors">
                <label class="form-label">顏色選擇1：</label>
            ...
            <div class="mb-3 hidden" id="balloon-colors-2">
                <label class="form-label">顏色選擇2：</label>
        ...
        <div class="section">
            ...
            <div class="mb-3 hidden" id="color-choice-text">
